...
void main_code(LibMeshInit &init,
  ...
  eq_sys.parameters.set<Real> ("f_limit")             = Parameters[0];
  eq_sys.parameters.set<int>  ("sm_timer")            = (int) Parameters[1];
  eq_sys.parameters.set<Real> ("prol_intes")          = 0.19590731416087717;
